...
pytesseract.pytesseract.tesseract_cmd = r"NutritionData/BlackBeansNutritionLabel.jpg"
...
p=results["text"].index("Protein/Proteinas")
p_value=results["text"][int(p+1)]

p_value=int(p_value)
print(f"Value of Protein/Proteinas:{p_value}")

#p will be index postion of protiens
